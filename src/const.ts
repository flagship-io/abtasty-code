...
export const CURRENT_SECRET_CREDENTIALS = 'abtasty_secret_credentials';
export const DOCUMENT_URI = 'https://docs.developers.flagship.io/docs/visual-studio-code-abtasty-extension';
